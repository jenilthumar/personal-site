  ...
  return (
    <div className="flex flex-col gap-14 lg:gap-24">
      {/* The opening statement is the page's heading. 64px from 1440 up, over
          ...
          Leading and tracking are both a step looser than the Figma's 1.05 /
          -2.4px: at this size the lines were closing up on each other and the
          letters were set tighter than they needed to be. Tracking is in em so
          it holds its proportion as the type scales. InterVariable's optical
          size axis sits at its display end via font-optical-sizing. */}
      <h1 className="max-w-[1376px] py-2.5 text-[clamp(1.75rem,4.444vw,4rem)] font-medium leading-[1.1] tracking-[-0.035em] text-on-surface">
        {site.statement}
      </h1>
