...
export function Footer() {
  ...
  return (
    <footer className="mt-20 border-t border-oxley-700/40 pt-12 pb-6 text-sm leading-[1.4] lg:mt-32">
      <div className="flex flex-col gap-8 sm:flex-row sm:items-start sm:justify-between sm:gap-12">
        ...
        <div className="flex flex-col gap-1 text-oxley-700 sm:items-end">
          <p>{site.location}</p>
          <p>© {year}</p>
        </div>
      </div>
